...
export default function ChangelogWidgetPreview() {
  return (
    <div>
      <div className="border dark:border-active-dark border-border-secondary rounded-[18px] dark:bg-bg-primary-dark mx-auto w-[69%] shadow-[0px_12px_12px_-8px_#8889961A,0px_-6px_0px_0px_#ECECEC66_inset] p-[27px] mb-4 bg-white h-fit">
