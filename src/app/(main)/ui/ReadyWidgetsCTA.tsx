...
export default function ReadyWidgetsCTA() {
  return (
    <section className="pt-20 pb-[164px] max-md:pb-20 max-md:pt-10 px-12 max-xl:px-4">
      <div className="relative shadow-[0px_-2.4px_0px_0px_#3E3E3E0A_inset,0px_0px_0px_1px_#EBEBEB,0px_1px_3px_0px_#8F8F8F33] rounded-3xl py-[66px] max-sm:py-6 mx-auto px-4">
