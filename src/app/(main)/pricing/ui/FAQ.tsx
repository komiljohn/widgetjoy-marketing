    ...
    <section className="py-20">
      <div className="max-w-[532px] mx-auto text-center mb-20">
        ...
        <FadeInWhenVisible delay={0.1}>
          <SimpleText className="text-text-disabled text-lg px-12">Everything you need to know.</SimpleText>
        </FadeInWhenVisible>
      </div>
      <OpacityWhenVisible viewport={{ margin: "400px" }}>
        <div className="max-w-[700px] mx-auto py-10 px-5 bg-white rounded-2xl shadow-[0px_-4px_0px_0px_#3E3E3E0A_inset,0px_1px_3px_0px_#8F8F8F33]">
          <Accordion data={accordionData} />
          <div className="text-center mt-8">
            <div className="bg-widget-bg rounded-2xl py-12 px-[131px]">
              <SimpleText className="text-2xl mb-3 text-bg-overlay" weight="font-semibold">
                Don't see what you're looking for?
              </SimpleText>
              <SimpleText className="text-lg mb-[28px]" color="secondary-700">
