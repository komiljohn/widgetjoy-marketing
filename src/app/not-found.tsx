  ...
  return (
    <main className="bg-white dark:bg-bg-primary-dark h-dvh flex justify-center items-center bg-404-light-bg dark:bg-404-dark-bg bg-no-repeat bg-[center_top]">
      <div className="max-w-[768px] mx-auto text-center">
        ...
        <Heading className="mb-6 text-[60px] leading-[72px] font-semibold text-primary-900 dark:text-primary-dark-900">
          Page not found
        </Heading>
        <SimpleText className="text-xl mb-[50px] text-tertiary-600 dark:text-tertiary-dark-600">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Button className="text-base" onPress={() => router.push("/")}>
            Take me home
          </Button>
        </div>
      </div>
